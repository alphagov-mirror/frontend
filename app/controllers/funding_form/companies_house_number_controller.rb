class FundingForm::CompaniesHouseNumberController < ApplicationController
  ...
  def submit
    session[:company_house_or_charity_commision_number] = params[:company_house_or_charity_commision_number_yes] || params[:company_house_or_charity_commision_number]
